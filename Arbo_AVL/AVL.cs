...
namespace Arbo_AVL
{
    class AVL
    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if(Alturas(raiz.NodoIzquierdo) - Alturas(raiz.NodoDerecho) > 0)
                                {
                                    ...
                                    //Realiza las rotaciones simples o dobles segun sea el caso
                                }
                                else
                                {
        ...
        public void PosicionNodo(ref int xmin, int ymin)
        {
            ...
            //Si existen ambos nodos deja un espacio entre ellos
            if (NodoDerecho != null)
        ...
        public void DibujarNodo(Graphics grafo, Font fuente, Brush relleno, Brush rellenoFuente, Pen lapiz, int dato, Brush encuentro)
        {
            ...
            //Obtiene tel factor balanceo restando las alturas de cada nodo y las imprime
